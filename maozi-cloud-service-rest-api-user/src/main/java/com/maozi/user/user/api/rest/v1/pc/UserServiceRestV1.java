...
package com.maozi.user.user.api.rest.v1.pc;
...
//@FeignClient(value = "maozi-cloud-user", configuration = FeignRequestConfiguration.class, fallback = ProfileFeignFallback.class)
@Api(tags = "【后台】【V1】用户模块")
